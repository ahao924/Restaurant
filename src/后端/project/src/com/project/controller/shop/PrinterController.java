...
public class PrinterController extends BaseController{
	...
	public void save() throws Exception{
		...
		shop_printer.set("title", title)
					.set("shop_id", getLoginShopId())
					.set("user_code", user_code)
					.set("user_pwd", user_pwd)
					.set("printer_code", printer_code)
					.set("printer_pwd", printer_pwd)
					.set("type", getPara("type"))
					.set("status", ShopPrinter.STATUS_ENABLE)
	...
	public void changeStatus() throws Exception{
		...
		shop_printer.set("status", getPara("status"))
					.update();
		setAttr("success", true);
		setAttr("msg", "操作成功");
		renderJson();
