...
public class DishesController extends BaseController{
	...
	public void edit() throws Exception{
		...
		for(DishesFormat dishes_format : dishes_format_list){
			DishesFormat shop_dishes_format=DishesFormat.dao.findFirst("select * from db_dishes_format where dishes_id=? and title_1=? and title_2=? and title_3=?", dishes.get("id"), dishes_format.get("title_1"), dishes_format.get("title_2"), dishes_format.get("title_3"));
	...
	public void update() throws Exception{
		...
		Dishes shop_dishes = Dishes.dao.findFirst("select * from db_dishes where parent_dishes_id=? and shop_id=?", dishes.get("parent_dishes_id"), getLoginShopId());
	...
	public void changeStatus() throws Exception{
		...
		dishes.set("status", getPara("status"))
				.update();
		setAttr("success", true);
		setAttr("msg", "操作成功");
		renderJson();
	...
	public void deleted() throws Exception{
		...
		dishes.set("display", Dishes.DISPLAY_NO)
				.update();
		setAttr("success", true);
		setAttr("msg", "操作成功");
		renderJson();
