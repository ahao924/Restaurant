...
public class OrderController extends BaseController{
	...
	public void tables() throws Exception{
		...
		Tables tables=Tables.dao.findFirst("select * from db_tables where shop_id=? and system=? and title=?", getLoginShopId(), Tables.SYSTEM_YES, "代客点餐");
	...
	public void addShopping() throws Exception{
		...
		ShoppingCart shopping_cart=ShoppingCart.getByShopDishesFormat(getLoginShopId(), dishes.get("id"), dishes_format);
		if(shopping_cart!=null){
			shopping_cart.set("number", Integer.parseInt(number) + shopping_cart.getInt("number"))
							.update();
		}else{
