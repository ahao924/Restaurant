...
public class BusinessDishesController extends BaseController{
	...
	public void index() throws Exception{
		...
		for(Record item : list){
			...
			//是否上架
			Dishes shop_dishes = Dishes.dao.findFirst("select * from db_dishes where parent_dishes_id=? and shop_id=? and display=?", item.get("id"), getLoginShopId(), Dishes.DISPLAY_YES);
			if(shop_dishes!=null){
				item.set("shop", 1);
			}else{
				item.set("shop", 0);
	...
	public void save() throws Exception{
		...
		Dishes shop_dishes = Dishes.dao.findFirst("select * from db_dishes where parent_dishes_id=? and shop_id=?", dishes.get("id"), getLoginShopId());
		if(shop_dishes!=null){
			shop_dishes.set("title", dishes.get("title"))
						.set("dishes_type_id", dishes.get("dishes_type_id"))
						.set("img_url", dishes.get("img_url"))
						.set("remark", dishes.get("remark"))
						.set("sale_number",	0)
						.set("shuxing_number", dishes.get("shuxing_number"))
						.set("shuxing_1", dishes.get("shuxing_1"))
						.set("shuxing_2", dishes.get("shuxing_2"))
						.set("shuxing_3", dishes.get("shuxing_3"))
						.set("top", dishes.get("top"))
						.set("hot", dishes.get("hot"))
						.set("display", Dishes.DISPLAY_YES)
						.set("status", Dishes.STATUS_XIAOSHOU)
						.set("create_date", new Date())
						.update();
		}else{
			shop_dishes =new Dishes();
			shop_dishes.set("code", (int)(Math.random() * 90000) + 10000)
						.set("title", dishes.get("title"))
						.set("dishes_type_id", dishes.get("dishes_type_id"))
						.set("img_url", dishes.get("img_url"))
						.set("remark", dishes.get("remark"))
						.set("sale_number",	0)
						...
						.set("top", dishes.get("top"))
						.set("hot", dishes.get("hot"))
						.set("parent_dishes_id", dishes.get("id"))
						.set("shop_id", getLoginShopId())
						.set("business_id", dishes.get("business_id"))
						.set("display", Dishes.DISPLAY_YES)
						.set("status", Dishes.STATUS_XIAOSHOU)
						.set("create_date", new Date())
						.save();
		...
		for(DishesFormat dishes_format : dishes_format_list){
			...
			shop_dishes_format.set("title_1", dishes_format.get("title_1"))
								.set("title_2", dishes_format.get("title_2"))
								...
								.set("dishes_id", shop_dishes.get("id"))
								.set("create_date", new Date())
								.save();
