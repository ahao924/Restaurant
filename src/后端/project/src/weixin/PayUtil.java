...
public class PayUtil{
	...
	public static SortedMap<String, String> getPackageFuwu(WxPayDto tpWxPayDto) throws Exception{
		...
		String xml = "<xml>"
						...
						+ "<sub_appid>" + tpWxPayDto.getAppid() + "</sub_appid>"
						+ "<sub_mch_id>" + tpWxPayDto.getPartner() + "</sub_mch_id>"
						+ "<nonce_str>" + nonce_str + "</nonce_str>"
						+ "<sign>" + sign + "</sign>"
						+ "<body><![CDATA[" + body + "]]></body>" 
						+ "<out_trade_no>" + out_trade_no + "</out_trade_no>"
	...
	public static String refundPaymentFuwu(WxPayDto tpWxPayDto, String license) throws Exception{
		...
		String xml = "<xml>" + 
						...
						"</xml>";
		String createOrderURL = "https://api.mch.weixin.qq.com/secapi/pay/refund";
		String refundResult = ClientCustomSSL.doRefund(createOrderURL, xml, mch_id, PropKit.get("fuwushang_license").toString());
		System.out.println(refundResult);
		return refundResult;
	}
	/**
